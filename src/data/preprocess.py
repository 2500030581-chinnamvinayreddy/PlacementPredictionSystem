...
if __name__ == "__main__":
    ...
    X_train.to_csv(
        r"C:\Users\ADMIN\PycharmProjects\PlacementPredictionSystem\data\preprocessed_train.csv",
        index=False
    )
    X_test.to_csv(
        r"C:\Users\ADMIN\PycharmProjects\PlacementPredictionSystem\data\preprocessed_test.csv",
        index=False
    )
